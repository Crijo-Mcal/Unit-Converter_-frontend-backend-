...
export default function Navbar({ setTypeConverted }: prop) {
  ...
  return (
    <motion.nav
      ...
      className="static lg:absolute w-full lg:w-[435px] min-h-[60px] flex justify-center items-center bg-secondary lg:top-0 lg:right-0 lg:rounded-tr-2xl lg:rounded-bl-2xl overflow-hidden">
