...
export default function Footer() {
  return (
    <motion.footer
      ...
      className="static lg:absolute w-full lg:w-[330px] h-[60px] bg-secondary lg:bg-transparent  bottom-0 right-0 flex justify-center lg:justify-between items-center ">
